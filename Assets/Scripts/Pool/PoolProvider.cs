...
public class PoolProvider
{
    ...
    public PoolProvider(PoolInstantiateObject<PoolMember> poolInstantiateObject, Transform _content)
    {
        PoolFactory = new PoolFactory(poolInstantiateObject, _content);
